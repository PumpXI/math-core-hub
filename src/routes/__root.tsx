...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "STEMLab — Matemáticas universitarias" },
      { name: "description", content: "Plataforma educativa para estudiantes universitarios de Costa Rica y Latinoamérica." },
      { name: "author", content: "STEMLab" },
      { property: "og:title", content: "STEMLab — Matemáticas universitarias" },
